        ...
        [
          {
            ...
            description: 'Из-за политики безопастности AWS, я не стал писать дополнительные письма для того чтобы полностью сделать доступным 465 порт для SMPTS, а сделал в приложении автоматическое регистрирование пользователей, вместо рабочего функционала для подтверждения новых пользователей. Весб этот функционал временно задизейблен',
          },
          {
